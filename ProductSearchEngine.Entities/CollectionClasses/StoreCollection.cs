...
namespace ProductSearchEngine.CollectionClasses
{
	...
	public partial class StoreCollection : EntityCollectionBase<StoreEntity>
	{
		...
		public StoreCollection(IEnumerable<StoreEntity> initialContents):base(new StoreEntityFactory())
		{
		...
		public bool GetMultiManyToOne(IEntity membershipInstance)
		{
			return GetMultiManyToOne(membershipInstance, this.MaxNumberOfItemsToReturn, this.SortClauses, null, 0, 0);
		}
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(IEntity membershipInstance, IPredicateExpression filter)
		{
			return GetMultiManyToOne(membershipInstance, this.MaxNumberOfItemsToReturn, this.SortClauses, filter, 0, 0);
		}
		...
		/// <param name="filter">Extra filter to limit the resultset. Predicate expression can be null, in which case it will be ignored.</param>
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(IEntity membershipInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPredicateExpression filter)
		{
			return GetMultiManyToOne(membershipInstance, maxNumberOfItemsToReturn, sortClauses, filter, 0, 0);
		}
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public virtual bool GetMultiManyToOne(IEntity membershipInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPredicateExpression filter, int pageNumber, int pageSize)
		{
			bool validParameters = false;
			validParameters |= (membershipInstance!=null);
			if(!validParameters)
			{
			...
			return DAOFactory.CreateStoreDAO().GetMulti(this.Transaction, this, maxNumberOfItemsToReturn, sortClauses, this.EntityFactoryToUse, filter, membershipInstance, pageNumber, pageSize);
		}
		...
		public int DeleteMultiManyToOne(IEntity membershipInstance)
		{
			return DAOFactory.CreateStoreDAO().DeleteMulti(this.Transaction, membershipInstance);
		}
		...
		/// <param name="membershipInstance">MembershipEntity instance to use as a filter for the StoreEntity objects to return</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMultiManyToOne(StoreEntity entityWithNewValues, IEntity membershipInstance)
		{
			return DAOFactory.CreateStoreDAO().UpdateMulti(entityWithNewValues, this.Transaction, membershipInstance);
		}
		...
		public virtual object GetScalar(StoreFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply, IPredicate filter, IRelationCollection relations, IGroupByCollection groupByClause)
		{
			...
			return DAOFactory.CreateStoreDAO().GetScalar(fields, this.Transaction, filter, relations, groupByClause);
		}
