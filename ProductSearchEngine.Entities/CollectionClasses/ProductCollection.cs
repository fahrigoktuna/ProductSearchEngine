...
namespace ProductSearchEngine.CollectionClasses
{
	...
	public partial class ProductCollection : EntityCollectionBase<ProductEntity>
	{
		...
		public bool GetMultiManyToOne(IEntity brandInstance, IEntity categoryInstance, IEntity storeInstance)
		{
			return GetMultiManyToOne(brandInstance, categoryInstance, storeInstance, this.MaxNumberOfItemsToReturn, this.SortClauses, null, 0, 0);
		}
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(IEntity brandInstance, IEntity categoryInstance, IEntity storeInstance, IPredicateExpression filter)
		{
			return GetMultiManyToOne(brandInstance, categoryInstance, storeInstance, this.MaxNumberOfItemsToReturn, this.SortClauses, filter, 0, 0);
		}
		...
		/// <param name="filter">Extra filter to limit the resultset. Predicate expression can be null, in which case it will be ignored.</param>
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(IEntity brandInstance, IEntity categoryInstance, IEntity storeInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPredicateExpression filter)
		{
			return GetMultiManyToOne(brandInstance, categoryInstance, storeInstance, maxNumberOfItemsToReturn, sortClauses, filter, 0, 0);
		}
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public virtual bool GetMultiManyToOne(IEntity brandInstance, IEntity categoryInstance, IEntity storeInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPredicateExpression filter, int pageNumber, int pageSize)
		{
			bool validParameters = false;
			validParameters |= (brandInstance!=null);
			validParameters |= (categoryInstance!=null);
			validParameters |= (storeInstance!=null);
			if(!validParameters)
			{
			...
			return DAOFactory.CreateProductDAO().GetMulti(this.Transaction, this, maxNumberOfItemsToReturn, sortClauses, this.EntityFactoryToUse, filter, brandInstance, categoryInstance, storeInstance, pageNumber, pageSize);
		}
		...
		public int DeleteMultiManyToOne(IEntity brandInstance, IEntity categoryInstance, IEntity storeInstance)
		{
			return DAOFactory.CreateProductDAO().DeleteMulti(this.Transaction, brandInstance, categoryInstance, storeInstance);
		}
		...
		/// <param name="storeInstance">StoreEntity instance to use as a filter for the ProductEntity objects to return</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMultiManyToOne(ProductEntity entityWithNewValues, IEntity brandInstance, IEntity categoryInstance, IEntity storeInstance)
		{
			return DAOFactory.CreateProductDAO().UpdateMulti(entityWithNewValues, this.Transaction, brandInstance, categoryInstance, storeInstance);
		}
