...
namespace ProductSearchEngine.DaoClasses
{
	...
	/// <summary>General DAO class for the Keyword Entity. It will perform database oriented actions for a entity of type 'KeywordEntity'.</summary>
	public partial class KeywordDAO : CommonDaoBase
	{
		/// <summary>CTor</summary>
		public KeywordDAO() : base(InheritanceHierarchyType.None, "KeywordEntity", new KeywordEntityFactory())
		{
		}
