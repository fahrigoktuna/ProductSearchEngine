...
namespace ProductSearchEngine.HelperClasses
{
	...
	internal class PersistenceInfoProviderCore : PersistenceInfoProviderBase
	{
		...
		{
			this.AddElementMapping( "CommentEntity", "ProductSearchEngine", @"dbo", "Comment", 5 );
			...
			this.AddElementFieldMapping( "CommentEntity", "Title", "Title", true, "NVarChar", 250, 0, 0, false, "", null, typeof(System.String), 4 );
		}
		...
		{
			this.AddElementMapping( "MembershipEntity", "ProductSearchEngine", @"dbo", "Membership", 5 );
			...
			this.AddElementFieldMapping( "MembershipEntity", "Status", "Status", true, "Bit", 0, 0, 0, false, "", null, typeof(System.Boolean), 2 );
			this.AddElementFieldMapping( "MembershipEntity", "StoreInformationId", "StoreInformationId", true, "Int", 0, 0, 10, false, "", null, typeof(System.Int32), 3 );
			this.AddElementFieldMapping( "MembershipEntity", "UserName", "UserName", true, "NVarChar", 250, 0, 0, false, "", null, typeof(System.String), 4 );
		}
