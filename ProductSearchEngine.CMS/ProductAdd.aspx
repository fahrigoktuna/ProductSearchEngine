<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true"
    CodeBehind="ProductAdd.aspx.cs" Inherits="ProductSearchEngine.CMS.ProductAdd" %>
        ...
        <div class="container_12">
            <div class="grid_12">
                <h1>
                    Product Add Page</h1>
                <p>
                    You can add your product informations at below by filling the field sets.</p>
            </div>

            <asp:Panel ID="ProductAddPanel" runat="server">
                        ...
                        <ul class="actions-right">
                            <li>
                                <asp:Button ID="SubmitButton"  runat="server" OnClick="SubmitButton_Click"  CssClass="button"
                                    Text="Add Product" />
                                    <asp:Button ID="SubmitEditButton" Visible="false" runat="server" OnClick="SubmitButtonUpdate_Click"  CssClass="button"
                                    Text="Save Changes" />
                            </li>
                        </ul>
                    </div>
            ...
            <asp:Panel ID="ProductSpecificationPanel" Visible="false" runat="server">
                <div class="grid_6">
                    <div class="block-border">
                        <div class="block-header">
                            <h1>
                            ...
                            <asp:Repeater ID="ProductSpecificationsRepeater" runat="server">
                                ...
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:LinkButton ID="SpecificationRemoveLinkButton" runat="server" Text="Remove" CommandArgument='<%#Eval("ProductId").ToString()+","+Eval("SpecificationName").ToString()%>'
                                                OnClick="SpecificationRemoveLinkButton_Click"></asp:LinkButton>
                                        </td>
                                    </tr>
                                </ItemTemplate>
                                <FooterTemplate>
            ...
            <asp:Panel ID="ProductSpecificationAddPanel" Visible="false" runat="server">
                <div class="grid_6">
                    <div class="block-border">
                        <div class="block-header">
                            <h1>
            ...
            <asp:Panel ID="ProductKeywordAddPanel" Visible="false" runat="server">
                <div class="grid_6">
                    <div class="block-border">
                        <div class="block-header">
                            <h1>
                            ...
                            <asp:Repeater ID="ProductKeywordRepeater" runat="server">
                                ...
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:LinkButton ID="KeywordRemoveLinkButton" runat="server" Text="Remove" CommandArgument='<%#Eval("ProductId").ToString()+","+Eval("KeywordId").ToString()%>'
                                                OnClick="KeywordRemoveLinkButton_Click"></asp:LinkButton>
                                        </td>
                                    </tr>
                                </ItemTemplate>
                                <FooterTemplate>
            ...
            <asp:Panel ID="ProductPhotoPanel" Visible="false" runat="server">
                <div class="grid_6">
                    <div class="block-border">
                        <div class="block-header">
                            <h1>
                        ...
                        <div id="form" class="block-content form">
                            <asp:Repeater ID="ProductPhotosRepeater" runat="server">
                                ...
                                <ItemTemplate>
                                    <tr>
                                        <td>
                                            <asp:Image ID="ProductPhotoImage" Width="80" Height="80" ImageUrl='<%#ConfigurationManager.AppSettings["ImagePath"] +"/" + Eval("UniqueName").ToString()%>'
                                                runat="server" />
                                        </td>
                                        <td>
                                            <asp:LinkButton ID="PhotoRemoveLinkButton" CommandArgument='<%#Eval("Id").ToString() %>'
                                                OnClick="PhotoRemoveLinkButton_Click" runat="server" Text="Remove"></asp:LinkButton>
                                        </td>
                                    </tr>
                                </ItemTemplate>
                                <FooterTemplate>
            ...
            <asp:Panel ID="ProductKeywordPanel" Visible="false" runat="server">
                <div class="grid_6">
                    <div class="block-border">
                        <div class="block-header">
                            <h1>
