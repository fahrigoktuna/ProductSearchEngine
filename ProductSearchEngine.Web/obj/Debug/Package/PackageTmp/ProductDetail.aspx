                ...
                <div id="product" class="grid_12">
                    ...
                    <div id="product_info" class="grid_6 omega">
                        ...
                        <dl class="clearfix">
                            ...
                            <dt>Brand</dt>
                            <dd>
                                <a href='<%#GetBrandRedirectUrl(int.Parse(Eval("BrandId")== null ? "0" : Eval("BrandId").ToString())) %>'>
                                   <%#Eval("Brand.Name") %></a></dd>
                            <dt>Category</dt>
                            <dd>
                                <a href='<%#GetCategoryRedirectUrl(int.Parse(Eval("CategoryId").ToString())) %>'>
                                    <%#Eval("Category.Name") %></a></dd>
