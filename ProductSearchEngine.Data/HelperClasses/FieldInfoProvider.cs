...
namespace ProductSearchEngine.HelperClasses
{
	...
	internal class FieldInfoProviderCore : FieldInfoProviderBase
	{
		...
		private void Init()
		{
			...
			InitLastViewedProductEntityInfos();
		...
		private void InitCommentEntityInfos()
		{
			...
			this.AddElementFieldInfo("CommentEntity", "Status", typeof(Nullable<System.Boolean>), false, false, false, true,  (int)CommentFieldIndex.Status, 0, 0, 0);
		...
		/// <summary>Inits LastViewedProductEntity's FieldInfo objects</summary>
		private void InitLastViewedProductEntityInfos()
		{
			this.AddFieldIndexEnumForElementName(typeof(LastViewedProductFieldIndex), "LastViewedProductEntity");
			this.AddElementFieldInfo("LastViewedProductEntity", "Id", typeof(System.Int32), true, false, true, false,  (int)LastViewedProductFieldIndex.Id, 0, 0, 10);
			this.AddElementFieldInfo("LastViewedProductEntity", "IpAdrees", typeof(System.String), false, false, false, true,  (int)LastViewedProductFieldIndex.IpAdrees, 150, 0, 0);
			this.AddElementFieldInfo("LastViewedProductEntity", "ProductId", typeof(Nullable<System.Int32>), false, true, false, true,  (int)LastViewedProductFieldIndex.ProductId, 0, 0, 10);
			this.AddElementFieldInfo("LastViewedProductEntity", "ViewedTime", typeof(Nullable<System.DateTime>), false, false, false, true,  (int)LastViewedProductFieldIndex.ViewedTime, 0, 0, 0);
		}
		...
		private void InitMembershipEntityInfos()
		{
			...
			this.AddElementFieldInfo("MembershipEntity", "RoleId", typeof(Nullable<System.Int32>), false, true, false, true,  (int)MembershipFieldIndex.RoleId, 0, 0, 10);
		...
		/// <summary>Inits WebTrackerEntity's FieldInfo objects</summary>
		private void InitWebTrackerEntityInfos()
		{
			this.AddFieldIndexEnumForElementName(typeof(WebTrackerFieldIndex), "WebTrackerEntity");
			this.AddElementFieldInfo("WebTrackerEntity", "Browser", typeof(System.String), false, false, false, true,  (int)WebTrackerFieldIndex.Browser, 500, 0, 0);
			this.AddElementFieldInfo("WebTrackerEntity", "Id", typeof(System.Int32), true, false, true, false,  (int)WebTrackerFieldIndex.Id, 0, 0, 10);
			this.AddElementFieldInfo("WebTrackerEntity", "IpAddress", typeof(System.String), false, false, false, true,  (int)WebTrackerFieldIndex.IpAddress, 150, 0, 0);
			this.AddElementFieldInfo("WebTrackerEntity", "VisitTime", typeof(Nullable<System.DateTime>), false, false, false, true,  (int)WebTrackerFieldIndex.VisitTime, 0, 0, 0);
		}
