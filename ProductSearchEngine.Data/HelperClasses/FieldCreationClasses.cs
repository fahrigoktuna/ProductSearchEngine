...
namespace ProductSearchEngine.HelperClasses
{
	...
	public partial class CommentFields
	{
		...
		/// <summary>Creates a new CommentEntity.Status field instance</summary>
		public static EntityField Status
		{
			get { return (EntityField)EntityFieldFactory.Create(CommentFieldIndex.Status);}
		}
	...
	/// <summary>Field Creation Class for entity LastViewedProductEntity</summary>
	public partial class LastViewedProductFields
	{
		/// <summary>Creates a new LastViewedProductEntity.Id field instance</summary>
		public static EntityField Id
		{
			get { return (EntityField)EntityFieldFactory.Create(LastViewedProductFieldIndex.Id);}
		}
		/// <summary>Creates a new LastViewedProductEntity.IpAdrees field instance</summary>
		public static EntityField IpAdrees
		{
			get { return (EntityField)EntityFieldFactory.Create(LastViewedProductFieldIndex.IpAdrees);}
		}
		/// <summary>Creates a new LastViewedProductEntity.ProductId field instance</summary>
		public static EntityField ProductId
		{
			get { return (EntityField)EntityFieldFactory.Create(LastViewedProductFieldIndex.ProductId);}
		}
		/// <summary>Creates a new LastViewedProductEntity.ViewedTime field instance</summary>
		public static EntityField ViewedTime
		{
			get { return (EntityField)EntityFieldFactory.Create(LastViewedProductFieldIndex.ViewedTime);}
		}
	}
	...
	public partial class MembershipFields
	{
		...
		/// <summary>Creates a new MembershipEntity.RoleId field instance</summary>
		public static EntityField RoleId
		{
			get { return (EntityField)EntityFieldFactory.Create(MembershipFieldIndex.RoleId);}
		}
	...
	public partial class RoleFields
	{
		...
		public static EntityField Id
		{
			get { return (EntityField)EntityFieldFactory.Create(RoleFieldIndex.Id);}
		}
	...
	/// <summary>Field Creation Class for entity WebTrackerEntity</summary>
	public partial class WebTrackerFields
	{
		/// <summary>Creates a new WebTrackerEntity.Browser field instance</summary>
		public static EntityField Browser
		{
			get { return (EntityField)EntityFieldFactory.Create(WebTrackerFieldIndex.Browser);}
		}
		/// <summary>Creates a new WebTrackerEntity.Id field instance</summary>
		public static EntityField Id
		{
			get { return (EntityField)EntityFieldFactory.Create(WebTrackerFieldIndex.Id);}
		}
		/// <summary>Creates a new WebTrackerEntity.IpAddress field instance</summary>
		public static EntityField IpAddress
		{
			get { return (EntityField)EntityFieldFactory.Create(WebTrackerFieldIndex.IpAddress);}
		}
		/// <summary>Creates a new WebTrackerEntity.VisitTime field instance</summary>
		public static EntityField VisitTime
		{
			get { return (EntityField)EntityFieldFactory.Create(WebTrackerFieldIndex.VisitTime);}
		}
	}
