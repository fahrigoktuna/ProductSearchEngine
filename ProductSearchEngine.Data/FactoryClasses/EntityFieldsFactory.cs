...
namespace ProductSearchEngine.FactoryClasses
{
	...
	{
		private static readonly Dictionary<ProductSearchEngine.EntityType, string> _entityTypeNamesCache = new Dictionary<ProductSearchEngine.EntityType, string>();

		/// <summary>static ctor which initializes the static entity type cache.</summary>
		static EntityFieldsFactory()
		{
			foreach(ProductSearchEngine.EntityType value in Enum.GetValues(typeof(ProductSearchEngine.EntityType)))
			{
				_entityTypeNamesCache.Add(value, Enum.GetName(typeof(ProductSearchEngine.EntityType), value));
			}
		}	
