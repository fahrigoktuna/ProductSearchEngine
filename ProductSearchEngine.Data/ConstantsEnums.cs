...
namespace ProductSearchEngine
{
	...
	/// <summary>Index enum to fast-access EntityFields in the IEntityFields collection for the entity: LastViewedProduct.</summary>
	public enum LastViewedProductFieldIndex
	{
		///<summary>Id. </summary>
		Id,
		///<summary>IpAdrees. </summary>
		IpAdrees,
		///<summary>ProductId. </summary>
		ProductId,
		///<summary>ViewedTime. </summary>
		ViewedTime,
		/// <summary></summary>
		AmountOfFields
	}
	...
	/// <summary>Index enum to fast-access EntityFields in the IEntityFields collection for the entity: WebTracker.</summary>
	public enum WebTrackerFieldIndex
	{
	...
	public enum EntityType
	{
		...
		///<summary>Keyword</summary>
		KeywordEntity,
		///<summary>LastViewedProduct</summary>
		LastViewedProductEntity,
