...
namespace ProductSearchEngine.DaoClasses
{
	...
	public partial class MembershipDAO : CommonDaoBase
	{
		...
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
		/// <param name="roleInstance">RoleEntity instance to use as a filter for the MembershipEntity objects to delete</param>
		...
		public int DeleteMulti(ITransaction containingTransaction, IEntity roleInstance, IEntity storeInformationInstance)
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(ProductSearchEngine.EntityType.MembershipEntity);
			IPredicateExpression deleteFilter = CreateFilterUsingForeignKeys(roleInstance, storeInformationInstance, fields);
		...
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
		/// <param name="roleInstance">RoleEntity instance to use as a filter for the MembershipEntity objects to update</param>
		...
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(IEntity entityWithNewValues, ITransaction containingTransaction, IEntity roleInstance, IEntity storeInformationInstance)
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(ProductSearchEngine.EntityType.MembershipEntity);
			IPredicateExpression updateFilter = CreateFilterUsingForeignKeys(roleInstance, storeInformationInstance, fields);
