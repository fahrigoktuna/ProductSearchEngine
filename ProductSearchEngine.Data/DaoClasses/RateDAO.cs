...
namespace ProductSearchEngine.DaoClasses
{
	...
	/// <summary>General DAO class for the Rate Entity. It will perform database oriented actions for a entity of type 'RateEntity'.</summary>
	public partial class RateDAO : CommonDaoBase
	{
		/// <summary>CTor</summary>
		public RateDAO() : base(InheritanceHierarchyType.None, "RateEntity", new RateEntityFactory())
		{
		}
