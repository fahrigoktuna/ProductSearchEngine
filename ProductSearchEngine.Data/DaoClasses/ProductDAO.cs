...
namespace ProductSearchEngine.DaoClasses
{
	...
	public partial class ProductDAO : CommonDaoBase
	{
		...
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
		/// <param name="brandInstance">BrandEntity instance to use as a filter for the ProductEntity objects to delete</param>
		/// <param name="categoryInstance">CategoryEntity instance to use as a filter for the ProductEntity objects to delete</param>
		/// <param name="storeInstance">StoreEntity instance to use as a filter for the ProductEntity objects to delete</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int DeleteMulti(ITransaction containingTransaction, IEntity brandInstance, IEntity categoryInstance, IEntity storeInstance)
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(ProductSearchEngine.EntityType.ProductEntity);
			IPredicateExpression deleteFilter = CreateFilterUsingForeignKeys(brandInstance, categoryInstance, storeInstance, fields);
		...
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
		/// <param name="brandInstance">BrandEntity instance to use as a filter for the ProductEntity objects to update</param>
		/// <param name="categoryInstance">CategoryEntity instance to use as a filter for the ProductEntity objects to update</param>
		/// <param name="storeInstance">StoreEntity instance to use as a filter for the ProductEntity objects to update</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(IEntity entityWithNewValues, ITransaction containingTransaction, IEntity brandInstance, IEntity categoryInstance, IEntity storeInstance)
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(ProductSearchEngine.EntityType.ProductEntity);
			IPredicateExpression updateFilter = CreateFilterUsingForeignKeys(brandInstance, categoryInstance, storeInstance, fields);
