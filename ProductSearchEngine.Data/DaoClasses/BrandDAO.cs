...
namespace ProductSearchEngine.DaoClasses
{
	...
	/// <summary>General DAO class for the Brand Entity. It will perform database oriented actions for a entity of type 'BrandEntity'.</summary>
	public partial class BrandDAO : CommonDaoBase
	{
		/// <summary>CTor</summary>
		public BrandDAO() : base(InheritanceHierarchyType.None, "BrandEntity", new BrandEntityFactory())
		{
		}
