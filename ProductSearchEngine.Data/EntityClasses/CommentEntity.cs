...
namespace ProductSearchEngine.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'Comment'. <br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class CommentEntity : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private RateEntity _rate;
		private bool	_alwaysFetchRate, _alreadyFetchedRate, _rateReturnsNewIfNotFound;
		...
		public static partial class MemberNames
		{
			...
			/// <summary>Member name Rate</summary>
		...
		/// <summary>CTor</summary>
		/// <param name="id">PK value for Comment which data should be fetched into this Comment object</param>
		public CommentEntity(System.Int32 id)
		{
		...
		public CommentEntity(System.Int32 id, IPrefetchPath prefetchPathToUse)
		{
		...
		/// <summary>CTor</summary>
		/// <param name="id">PK value for Comment which data should be fetched into this Comment object</param>
		/// <param name="validator">The custom validator object for this CommentEntity</param>
		public CommentEntity(System.Int32 id, IValidator validator)
		{
		...
		{
			switch((CommentFieldIndex)fieldIndex)
			{
				case CommentFieldIndex.ProductId:
					DesetupSyncProduct(true, false);
					_alreadyFetchedProduct = false;
					break;
				case CommentFieldIndex.RateId:
					DesetupSyncRate(true, false);
					_alreadyFetchedRate = false;
					break;
				default:
		...
		protected override void PostReadXmlFixups()
		{
			...
			_alreadyFetchedRate = (_rate != null);
		}
		...
		internal static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			switch(fieldName)
			{
				case "Product":
					...
					break;
				case "Rate":
					toReturn.Add(Relations.RateEntityUsingRateId);
					break;
				default:
					break;				
			}
		...
		protected override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			...
			info.AddValue("_rate", (!this.MarkedForDeletion?_rate:null));
			info.AddValue("_rateReturnsNewIfNotFound", _rateReturnsNewIfNotFound);
			info.AddValue("_alwaysFetchRate", _alwaysFetchRate);
			info.AddValue("_alreadyFetchedRate", _alreadyFetchedRate);
		...
		protected override void SetRelatedEntityProperty(string propertyName, IEntity entity)
		{
			switch(propertyName)
			{
				case "Product":
					...
					break;
				case "Rate":
					_alreadyFetchedRate = true;
					this.Rate = (RateEntity)entity;
					break;
				default:
		...
		{
			return new CommentRelations().GetAllRelations();
		}
		...
		public RateEntity GetSingleRate()
		{
			return GetSingleRate(false);
		}
		...
		/// <param name="id">PK value for Comment which data should be fetched into this Comment object</param>
		/// <param name="validator">The validator object for this CommentEntity</param>
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		...
		private void InitClassMembers()
		{
			...
			_rateReturnsNewIfNotFound = false;
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("RateId", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
		...
		{
			this.PerformDesetupSyncRelatedEntity( _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", ProductSearchEngine.RelationClasses.StaticCommentRelations.ProductEntityUsingProductIdStatic, true, signalRelatedEntity, "Comments", resetFKFields, new int[] { (int)CommentFieldIndex.ProductId } );		
			_product = null;
		}
		...
		private void SetupSyncProduct(IEntity relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", ProductSearchEngine.RelationClasses.StaticCommentRelations.ProductEntityUsingProductIdStatic, true, ref _alreadyFetchedProduct, new string[] {  } );
			}
		}
		...
		/// <param name="sender"></param>
		/// <param name="e"></param>
		private void OnRatePropertyChanged( object sender, PropertyChangedEventArgs e )
		{
			switch( e.PropertyName )
			{
				default:
		...
		private bool Fetch(System.Int32 id, IPrefetchPath prefetchPathToUse, Context contextToUse, ExcludeIncludeFieldsList excludedIncludedFields)
		{
			...
			{
				OnFetch();
				this.Fields[(int)CommentFieldIndex.Id].ForcedCurrentValueWrite(id);
		...
		{
			return DAOFactory.CreateCommentDAO();
		}
		...
		public  static CommentRelations Relations
		{
			get	{ return new CommentRelations(); }
		}
		...
		{
			get	{ return new PrefetchPathElement(new ProductSearchEngine.CollectionClasses.ProductCollection(), (IEntityRelation)GetRelationsForField("Product")[0], (int)ProductSearchEngine.EntityType.CommentEntity, (int)ProductSearchEngine.EntityType.ProductEntity, 0, null, null, null, "Product", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}

		/// <summary> Creates a new PrefetchPathElement object which contains all the information to prefetch the related entities of type 'Rate'  for this entity.</summary>
		/// <returns>Ready to use IPrefetchPathElement implementation.</returns>
		public static IPrefetchPathElement PrefetchPathRate
		{
			get	{ return new PrefetchPathElement(new ProductSearchEngine.CollectionClasses.RateCollection(), (IEntityRelation)GetRelationsForField("Rate")[0], (int)ProductSearchEngine.EntityType.CommentEntity, (int)ProductSearchEngine.EntityType.RateEntity, 0, null, null, null, "Rate", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <summary> The Content property of the Entity Comment<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Comment"."Content"<br/>
		...
		{
			get { return (System.String)GetValue((int)CommentFieldIndex.Content, true); }
			set	{ SetValue((int)CommentFieldIndex.Content, value, true); }
		}

		/// <summary> The Id property of the Entity Comment<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Comment"."Id"<br/>
		/// Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, true</remarks>
		public virtual System.Int32 Id
		{
			get { return (System.Int32)GetValue((int)CommentFieldIndex.Id, true); }
			set	{ SetValue((int)CommentFieldIndex.Id, value, true); }
		}

		/// <summary> The ProductId property of the Entity Comment<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Comment"."ProductId"<br/>
		/// Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual Nullable<System.Int32> ProductId
		{
			get { return (Nullable<System.Int32>)GetValue((int)CommentFieldIndex.ProductId, false); }
			set	{ SetValue((int)CommentFieldIndex.ProductId, value, true); }
		}

		/// <summary> The RateId property of the Entity Comment<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Comment"."RateId"<br/>
		/// Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual Nullable<System.Int32> RateId
		{
			get { return (Nullable<System.Int32>)GetValue((int)CommentFieldIndex.RateId, false); }
			set	{ SetValue((int)CommentFieldIndex.RateId, value, true); }
		}

		/// <summary> The Status property of the Entity Comment<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Comment"."Status"<br/>
		/// Table field type characteristics (type, precision, scale, length): Bit, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual Nullable<System.Boolean> Status
		{
			get { return (Nullable<System.Boolean>)GetValue((int)CommentFieldIndex.Status, false); }
			set	{ SetValue((int)CommentFieldIndex.Status, value, true); }
		}

		/// <summary> The Title property of the Entity Comment<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Comment"."Title"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 250<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual System.String Title
		{
			get { return (System.String)GetValue((int)CommentFieldIndex.Title, true); }
			set	{ SetValue((int)CommentFieldIndex.Title, value, true); }
		}
		...
		public virtual ProductEntity Product
		{
			...
			{ 
				...
				{
					SetSingleRelatedEntityNavigator(value, "Comments", "Product", _product, true); 
				}
			}
		}
		...
		/// <summary> Gets / sets related entity of type 'RateEntity'. This property is not visible in databound grids.
		/// Setting this property to a new object will make the load-on-demand feature to stop fetching data from the database, until you set this
		/// property to null. Setting this property to an entity will make sure that FK-PK relations are synchronized when appropriate.<br/><br/>
		/// </summary>
		/// <remarks>This property is added for conveniance, however it is recommeded to use the method 'GetSingleRate()', because 
		/// this property is rather expensive and a method tells the user to cache the result when it has to be used more than once in the
		/// same scope. The property is marked non-browsable to make it hidden in bound controls, f.e. datagrids.</remarks>
		[Browsable(false)]
		public virtual RateEntity Rate
		{
			get	{ return GetSingleRate(false); }
			set 
			{ 
				if(this.IsDeserializing)
				{
				...
				{
					SetSingleRelatedEntityNavigator(value, "Comments", "Rate", _rate, true); 
				}
			}
		}

		/// <summary> Gets / sets the lazy loading flag for Rate. When set to true, Rate is always refetched from the 
		/// persistent storage. When set to false, the data is only fetched the first time Rate is accessed. You can always execute a forced fetch by calling GetSingleRate(true).</summary>
		[Browsable(false)]
		public bool AlwaysFetchRate
		{
			get	{ return _alwaysFetchRate; }
			set	{ _alwaysFetchRate = value; }	
		}
				
		/// <summary>Gets / Sets the lazy loading flag if the property Rate already has been fetched. Setting this property to false when Rate has been fetched
		/// will set Rate to null as well. Setting this property to true while Rate hasn't been fetched disables lazy loading for Rate</summary>
		[Browsable(false)]
		public bool AlreadyFetchedRate
		{
			get { return _alreadyFetchedRate;}
			set 
			{
				if(_alreadyFetchedRate && !value)
				{
					this.Rate = null;
				}
				_alreadyFetchedRate = value;
			}
		}

		/// <summary> Gets / sets the flag for what to do if the related entity available through the property Rate is not found
		/// in the database. When set to true, Rate will return a new entity instance if the related entity is not found, otherwise 
		/// null be returned if the related entity is not found. Default: false.</summary>
		[Browsable(false)]
		public bool RateReturnsNewIfNotFound
		{
			get	{ return _rateReturnsNewIfNotFound; }
			set { _rateReturnsNewIfNotFound = value; }	
		}
		...
		{ 
			get { return (int)ProductSearchEngine.EntityType.CommentEntity; }
		}
