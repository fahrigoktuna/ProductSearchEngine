...
namespace ProductSearchEngine.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'Brand'. <br/><br/>
	/// 
	/// </summary>
	[Serializable]
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public BrandEntity(System.Int32 id)
		{
		...
		public BrandEntity(System.Int32 id, IPrefetchPath prefetchPathToUse)
		{
		...
		public BrandEntity(System.Int32 id, IValidator validator)
		{
		...
		private void InitClassMembers()
		{
			...
			_products.SetContainingEntityInfo(this, "Brand");
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("PhotoUniqueName", fieldHashtable);
		}
		#endregion
		...
		private bool Fetch(System.Int32 id, IPrefetchPath prefetchPathToUse, Context contextToUse, ExcludeIncludeFieldsList excludedIncludedFields)
		{
			...
			{
				OnFetch();
				this.Fields[(int)BrandFieldIndex.Id].ForcedCurrentValueWrite(id);
		...
		/// <remarks>Mapped on  table field: "Brand"."Id"<br/>
		/// Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, true</remarks>
		public virtual System.Int32 Id
		{
			get { return (System.Int32)GetValue((int)BrandFieldIndex.Id, true); }
			set	{ SetValue((int)BrandFieldIndex.Id, value, true); }
		}
		...
		/// <summary> The PhotoUniqueName property of the Entity Brand<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Brand"."PhotoUniqueName"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 500<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual System.String PhotoUniqueName
		{
			get { return (System.String)GetValue((int)BrandFieldIndex.PhotoUniqueName, true); }
			set	{ SetValue((int)BrandFieldIndex.PhotoUniqueName, value, true); }
		}
		...
		{ 
			get { return (int)ProductSearchEngine.EntityType.BrandEntity; }
		}
