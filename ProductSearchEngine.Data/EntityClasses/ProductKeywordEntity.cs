...
namespace ProductSearchEngine.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'ProductKeyword'. <br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class ProductKeywordEntity : CommonEntityBase
		// __LLBLGENPRO_USER_CODE_REGION_START AdditionalInterfaces
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		#region Class Member Declarations
		private KeywordEntity _keyword;
		private bool	_alwaysFetchKeyword, _alreadyFetchedKeyword, _keywordReturnsNewIfNotFound;
		...
		{
			/// <summary>Member name Keyword</summary>
		...
		static ProductKeywordEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary>CTor</summary>
		public ProductKeywordEntity() : base()
		{
			InitClassEmpty(null);
		}
		...
		public ProductKeywordEntity(System.Int32 keywordId, System.Int32 productId)
		{
			InitClassFetch(keywordId, productId, null, null);
		}
		...
		public ProductKeywordEntity(System.Int32 keywordId, System.Int32 productId, IPrefetchPath prefetchPathToUse)
		{
			InitClassFetch(keywordId, productId, null, prefetchPathToUse);
		}

		/// <summary>CTor</summary>
		/// <param name="keywordId">PK value for ProductKeyword which data should be fetched into this ProductKeyword object</param>
		/// <param name="productId">PK value for ProductKeyword which data should be fetched into this ProductKeyword object</param>
		/// <param name="validator">The custom validator object for this ProductKeywordEntity</param>
		public ProductKeywordEntity(System.Int32 keywordId, System.Int32 productId, IValidator validator)
		{
			InitClassFetch(keywordId, productId, validator, null);
		}
		...
		{
			switch((ProductKeywordFieldIndex)fieldIndex)
			{
				case ProductKeywordFieldIndex.KeywordId:
					DesetupSyncKeyword(true, false);
					_alreadyFetchedKeyword = false;
					break;
				case ProductKeywordFieldIndex.ProductId:
		...
		{
			_alreadyFetchedKeyword = (_keyword != null);
		...
		internal static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "Keyword":
					toReturn.Add(Relations.KeywordEntityUsingKeywordId);
					break;
				case "Product":
		...
		{
			info.AddValue("_keyword", (!this.MarkedForDeletion?_keyword:null));
			info.AddValue("_keywordReturnsNewIfNotFound", _keywordReturnsNewIfNotFound);
			info.AddValue("_alwaysFetchKeyword", _alwaysFetchKeyword);
			info.AddValue("_alreadyFetchedKeyword", _alreadyFetchedKeyword);
		...
		protected override void SetRelatedEntityProperty(string propertyName, IEntity entity)
		{
			...
			{
				case "Keyword":
					_alreadyFetchedKeyword = true;
					this.Keyword = (KeywordEntity)entity;
					break;
				case "Product":
		...
		protected override void SetRelatedEntity(IEntity relatedEntity, string fieldName)
		{
			...
			{
				case "Keyword":
					SetupSyncKeyword(relatedEntity);
					break;
				case "Product":
		...
		public bool FetchUsingPK(System.Int32 keywordId, System.Int32 productId)
		{
			return FetchUsingPK(keywordId, productId, null, null, null);
		}
		...
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		/// <returns>True if succeeded, false otherwise.</returns>
		public bool FetchUsingPK(System.Int32 keywordId, System.Int32 productId, IPrefetchPath prefetchPathToUse)
		{
			return FetchUsingPK(keywordId, productId, prefetchPathToUse, null, null);
		}
		...
		/// <returns>True if succeeded, false otherwise.</returns>
		public bool FetchUsingPK(System.Int32 keywordId, System.Int32 productId, IPrefetchPath prefetchPathToUse, Context contextToUse)
		{
			return FetchUsingPK(keywordId, productId, prefetchPathToUse, contextToUse, null);
		}
		...
		{
			return Fetch(this.KeywordId, this.ProductId, null, null, null);
		}
		...
		{
			return new ProductKeywordRelations().GetAllRelations();
		}
		...
		public KeywordEntity GetSingleKeyword()
		{
			return GetSingleKeyword(false);
		}
		...
		/// <param name="keywordId">PK value for ProductKeyword which data should be fetched into this ProductKeyword object</param>
		/// <param name="productId">PK value for ProductKeyword which data should be fetched into this ProductKeyword object</param>
		/// <param name="validator">The validator object for this ProductKeywordEntity</param>
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		private void InitClassFetch(System.Int32 keywordId, System.Int32 productId, IValidator validator, IPrefetchPath prefetchPathToUse)
		{
			OnInitializing();
			this.Validator = validator;
			this.Fields = CreateFields();
			InitClassMembers();	
			Fetch(keywordId, productId, prefetchPathToUse, null, null);
		...
		{
			_keywordReturnsNewIfNotFound = false;
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			_fieldsCustomProperties.Add("KeywordId", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
		...
		{
			this.PerformDesetupSyncRelatedEntity( _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", ProductSearchEngine.RelationClasses.StaticProductKeywordRelations.ProductEntityUsingProductIdStatic, true, signalRelatedEntity, "ProductKeywords", resetFKFields, new int[] { (int)ProductKeywordFieldIndex.ProductId } );		
			_product = null;
		}
		...
		private void SetupSyncProduct(IEntity relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", ProductSearchEngine.RelationClasses.StaticProductKeywordRelations.ProductEntityUsingProductIdStatic, true, ref _alreadyFetchedProduct, new string[] {  } );
			}
		}
		...
		/// is set to false, the fields contained in excludedIncludedFields are kept in the query, the rest of the fields in the query are excluded.</param>
		/// <returns>True if succeeded, false otherwise.</returns>
		private bool Fetch(System.Int32 keywordId, System.Int32 productId, IPrefetchPath prefetchPathToUse, Context contextToUse, ExcludeIncludeFieldsList excludedIncludedFields)
		{
			try
			{
				OnFetch();
				this.Fields[(int)ProductKeywordFieldIndex.KeywordId].ForcedCurrentValueWrite(keywordId);
				this.Fields[(int)ProductKeywordFieldIndex.ProductId].ForcedCurrentValueWrite(productId);
		...
		{
			return DAOFactory.CreateProductKeywordDAO();
		}
		...
		{
			return new ProductKeywordEntityFactory();
		}

		#region Class Property Declarations
		/// <summary> The relations object holding all relations of this entity with other entity classes.</summary>
		public  static ProductKeywordRelations Relations
		{
			get	{ return new ProductKeywordRelations(); }
		}
		...
		/// <summary> Creates a new PrefetchPathElement object which contains all the information to prefetch the related entities of type 'Keyword'  for this entity.</summary>
		/// <returns>Ready to use IPrefetchPathElement implementation.</returns>
		public static IPrefetchPathElement PrefetchPathKeyword
		{
			get	{ return new PrefetchPathElement(new ProductSearchEngine.CollectionClasses.KeywordCollection(), (IEntityRelation)GetRelationsForField("Keyword")[0], (int)ProductSearchEngine.EntityType.ProductKeywordEntity, (int)ProductSearchEngine.EntityType.KeywordEntity, 0, null, null, null, "Keyword", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get { return "ProductKeywordEntity";}
		}
		...
		/// <summary> The KeywordId property of the Entity ProductKeyword<br/><br/></summary>
		/// <remarks>Mapped on  table field: "ProductKeyword"."KeywordId"<br/>
		/// Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Int32 KeywordId
		{
			get { return (System.Int32)GetValue((int)ProductKeywordFieldIndex.KeywordId, true); }
			set	{ SetValue((int)ProductKeywordFieldIndex.KeywordId, value, true); }
		}

		/// <summary> The ProductId property of the Entity ProductKeyword<br/><br/></summary>
		/// <remarks>Mapped on  table field: "ProductKeyword"."ProductId"<br/>
		/// Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Int32 ProductId
		{
			get { return (System.Int32)GetValue((int)ProductKeywordFieldIndex.ProductId, true); }
			set	{ SetValue((int)ProductKeywordFieldIndex.ProductId, value, true); }
		}


		/// <summary> Gets / sets related entity of type 'KeywordEntity'. This property is not visible in databound grids.
		/// Setting this property to a new object will make the load-on-demand feature to stop fetching data from the database, until you set this
		/// property to null. Setting this property to an entity will make sure that FK-PK relations are synchronized when appropriate.<br/><br/>
		/// </summary>
		/// <remarks>This property is added for conveniance, however it is recommeded to use the method 'GetSingleKeyword()', because 
		/// this property is rather expensive and a method tells the user to cache the result when it has to be used more than once in the
		/// same scope. The property is marked non-browsable to make it hidden in bound controls, f.e. datagrids.</remarks>
		[Browsable(false)]
		public virtual KeywordEntity Keyword
		{
			get	{ return GetSingleKeyword(false); }
			set 
			{ 
				if(this.IsDeserializing)
				{
					SetupSyncKeyword(value);
				}
				else
				{
					SetSingleRelatedEntityNavigator(value, "ProductKeywords", "Keyword", _keyword, true); 
				}
			}
		}

		/// <summary> Gets / sets the lazy loading flag for Keyword. When set to true, Keyword is always refetched from the 
		/// persistent storage. When set to false, the data is only fetched the first time Keyword is accessed. You can always execute a forced fetch by calling GetSingleKeyword(true).</summary>
		[Browsable(false)]
		public bool AlwaysFetchKeyword
		{
			get	{ return _alwaysFetchKeyword; }
			set	{ _alwaysFetchKeyword = value; }	
		}
				
		/// <summary>Gets / Sets the lazy loading flag if the property Keyword already has been fetched. Setting this property to false when Keyword has been fetched
		/// will set Keyword to null as well. Setting this property to true while Keyword hasn't been fetched disables lazy loading for Keyword</summary>
		[Browsable(false)]
		public bool AlreadyFetchedKeyword
		{
			get { return _alreadyFetchedKeyword;}
			set 
			{
				if(_alreadyFetchedKeyword && !value)
				{
					this.Keyword = null;
				}
				_alreadyFetchedKeyword = value;
			}
		}

		/// <summary> Gets / sets the flag for what to do if the related entity available through the property Keyword is not found
		/// in the database. When set to true, Keyword will return a new entity instance if the related entity is not found, otherwise 
		/// null be returned if the related entity is not found. Default: false.</summary>
		[Browsable(false)]
		public bool KeywordReturnsNewIfNotFound
		{
			get	{ return _keywordReturnsNewIfNotFound; }
			set { _keywordReturnsNewIfNotFound = value; }	
		}
		...
		public virtual ProductEntity Product
		{
			...
			{ 
				...
				{
					SetSingleRelatedEntityNavigator(value, "ProductKeywords", "Product", _product, true); 
				}
			}
		}
		...
		{ 
			get { return (int)ProductSearchEngine.EntityType.ProductKeywordEntity; }
		}
