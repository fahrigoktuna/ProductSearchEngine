...
namespace ProductSearchEngine.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'LastViewedProduct'. <br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class LastViewedProductEntity : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static LastViewedProductEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary>CTor</summary>
		public LastViewedProductEntity() : base()
		{
			InitClassEmpty(null);
		}
		
		/// <summary>CTor</summary>
		/// <param name="id">PK value for LastViewedProduct which data should be fetched into this LastViewedProduct object</param>
		public LastViewedProductEntity(System.Int32 id)
		{
		...
		public LastViewedProductEntity(System.Int32 id, IPrefetchPath prefetchPathToUse)
		{
		...
		/// <summary>CTor</summary>
		/// <param name="id">PK value for LastViewedProduct which data should be fetched into this LastViewedProduct object</param>
		/// <param name="validator">The custom validator object for this LastViewedProductEntity</param>
		public LastViewedProductEntity(System.Int32 id, IValidator validator)
		{
		...
		protected LastViewedProductEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((LastViewedProductFieldIndex)fieldIndex)
			{
				case LastViewedProductFieldIndex.ProductId:
		...
		{
			return new LastViewedProductRelations().GetAllRelations();
		}
		...
		/// <param name="id">PK value for LastViewedProduct which data should be fetched into this LastViewedProduct object</param>
		/// <param name="validator">The validator object for this LastViewedProductEntity</param>
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("IpAdrees", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("ProductId", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("ViewedTime", fieldHashtable);
		}
		#endregion
		...
		{
			this.PerformDesetupSyncRelatedEntity( _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", ProductSearchEngine.RelationClasses.StaticLastViewedProductRelations.ProductEntityUsingProductIdStatic, true, signalRelatedEntity, "LastViewedProducts", resetFKFields, new int[] { (int)LastViewedProductFieldIndex.ProductId } );		
			_product = null;
		}
		...
		private void SetupSyncProduct(IEntity relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", ProductSearchEngine.RelationClasses.StaticLastViewedProductRelations.ProductEntityUsingProductIdStatic, true, ref _alreadyFetchedProduct, new string[] {  } );
			}
		}
		...
		private bool Fetch(System.Int32 id, IPrefetchPath prefetchPathToUse, Context contextToUse, ExcludeIncludeFieldsList excludedIncludedFields)
		{
			...
			{
				OnFetch();
				this.Fields[(int)LastViewedProductFieldIndex.Id].ForcedCurrentValueWrite(id);
		...
		{
			return new LastViewedProductEntityFactory();
		}

		#region Class Property Declarations
		/// <summary> The relations object holding all relations of this entity with other entity classes.</summary>
		public  static LastViewedProductRelations Relations
		{
			get	{ return new LastViewedProductRelations(); }
		}
		...
		{
			get { return "LastViewedProductEntity";}
		}
		...
		/// <summary> The Id property of the Entity LastViewedProduct<br/><br/></summary>
		/// <remarks>Mapped on  table field: "LastViewedProduct"."Id"<br/>
		/// Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, true</remarks>
		public virtual System.Int32 Id
		{
			get { return (System.Int32)GetValue((int)LastViewedProductFieldIndex.Id, true); }
			set	{ SetValue((int)LastViewedProductFieldIndex.Id, value, true); }
		}

		/// <summary> The IpAdrees property of the Entity LastViewedProduct<br/><br/></summary>
		/// <remarks>Mapped on  table field: "LastViewedProduct"."IpAdrees"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 150<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual System.String IpAdrees
		{
			get { return (System.String)GetValue((int)LastViewedProductFieldIndex.IpAdrees, true); }
			set	{ SetValue((int)LastViewedProductFieldIndex.IpAdrees, value, true); }
		}

		/// <summary> The ProductId property of the Entity LastViewedProduct<br/><br/></summary>
		/// <remarks>Mapped on  table field: "LastViewedProduct"."ProductId"<br/>
		/// Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual Nullable<System.Int32> ProductId
		{
			get { return (Nullable<System.Int32>)GetValue((int)LastViewedProductFieldIndex.ProductId, false); }
			set	{ SetValue((int)LastViewedProductFieldIndex.ProductId, value, true); }
		}

		/// <summary> The ViewedTime property of the Entity LastViewedProduct<br/><br/></summary>
		/// <remarks>Mapped on  table field: "LastViewedProduct"."ViewedTime"<br/>
		/// Table field type characteristics (type, precision, scale, length): DateTime, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual Nullable<System.DateTime> ViewedTime
		{
			get { return (Nullable<System.DateTime>)GetValue((int)LastViewedProductFieldIndex.ViewedTime, false); }
			set	{ SetValue((int)LastViewedProductFieldIndex.ViewedTime, value, true); }
		}
		...
		public virtual ProductEntity Product
		{
			...
			{ 
				...
				{
					SetSingleRelatedEntityNavigator(value, "LastViewedProducts", "Product", _product, true); 
				}
			}
		}
		...
		{ 
			get { return (int)ProductSearchEngine.EntityType.LastViewedProductEntity; }
		}
