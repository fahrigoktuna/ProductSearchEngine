...
namespace ProductSearchEngine.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public ProductPhotoEntity(System.Int32 id)
		{
		...
		public ProductPhotoEntity(System.Int32 id, IValidator validator)
		{
		...
		protected override void PerformDesyncSetupFKFieldChange(int fieldIndex)
		{
			...
			{
				case ProductPhotoFieldIndex.ProductId:
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("UniqueName", fieldHashtable);
		}
		#endregion
		...
		private void SetupSyncProduct(IEntity relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", ProductSearchEngine.RelationClasses.StaticProductPhotoRelations.ProductEntityUsingProductIdStatic, true, ref _alreadyFetchedProduct, new string[] {  } );
			}
		}
		...
		private bool Fetch(System.Int32 id, IPrefetchPath prefetchPathToUse, Context contextToUse, ExcludeIncludeFieldsList excludedIncludedFields)
		{
			...
			{
				OnFetch();
				this.Fields[(int)ProductPhotoFieldIndex.Id].ForcedCurrentValueWrite(id);
		...
		/// <summary> The Id property of the Entity ProductPhoto<br/><br/></summary>
		/// <remarks>Mapped on  table field: "ProductPhoto"."Id"<br/>
		/// Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, true</remarks>
		public virtual System.Int32 Id
		{
			get { return (System.Int32)GetValue((int)ProductPhotoFieldIndex.Id, true); }
			set	{ SetValue((int)ProductPhotoFieldIndex.Id, value, true); }
		}

		/// <summary> The ProductId property of the Entity ProductPhoto<br/><br/></summary>
		/// <remarks>Mapped on  table field: "ProductPhoto"."ProductId"<br/>
		/// Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int32 ProductId
		{
			get { return (System.Int32)GetValue((int)ProductPhotoFieldIndex.ProductId, true); }
			set	{ SetValue((int)ProductPhotoFieldIndex.ProductId, value, true); }
		}

		/// <summary> The UniqueName property of the Entity ProductPhoto<br/><br/></summary>
		/// <remarks>Mapped on  table field: "ProductPhoto"."UniqueName"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 500<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual System.String UniqueName
		{
			get { return (System.String)GetValue((int)ProductPhotoFieldIndex.UniqueName, true); }
			set	{ SetValue((int)ProductPhotoFieldIndex.UniqueName, value, true); }
		}
		...
		public virtual ProductEntity Product
		{
			...
			{ 
				...
				{
					SetSingleRelatedEntityNavigator(value, "ProductPhotos", "Product", _product, true); 
				}
			}
		}
		...
		{ 
			get { return (int)ProductSearchEngine.EntityType.ProductPhotoEntity; }
		}
