...
namespace ProductSearchEngine.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected override void PerformDesyncSetupFKFieldChange(int fieldIndex)
		{
			...
			{
				case MembershipFieldIndex.RoleId:
		...
		private void InitClassMembers()
		{
			...
			_roleReturnsNewIfNotFound = false;
		...
		{
			this.PerformDesetupSyncRelatedEntity( _role, new PropertyChangedEventHandler( OnRolePropertyChanged ), "Role", ProductSearchEngine.RelationClasses.StaticMembershipRelations.RoleEntityUsingRoleIdStatic, true, signalRelatedEntity, "Memberships", resetFKFields, new int[] { (int)MembershipFieldIndex.RoleId } );		
			_role = null;
		}
		...
		private void SetupSyncRole(IEntity relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _role, new PropertyChangedEventHandler( OnRolePropertyChanged ), "Role", ProductSearchEngine.RelationClasses.StaticMembershipRelations.RoleEntityUsingRoleIdStatic, true, ref _alreadyFetchedRole, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement(new ProductSearchEngine.CollectionClasses.RoleCollection(), (IEntityRelation)GetRelationsForField("Role")[0], (int)ProductSearchEngine.EntityType.MembershipEntity, (int)ProductSearchEngine.EntityType.RoleEntity, 0, null, null, null, "Role", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <summary> The RoleId property of the Entity Membership<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Membership"."RoleId"<br/>
		/// Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual Nullable<System.Int32> RoleId
		{
			get { return (Nullable<System.Int32>)GetValue((int)MembershipFieldIndex.RoleId, false); }
			set	{ SetValue((int)MembershipFieldIndex.RoleId, value, true); }
		}
		...
		public virtual RoleEntity Role
		{
			...
			{ 
				...
				{
					SetSingleRelatedEntityNavigator(value, "Memberships", "Role", _role, true); 
				}
			}
		}
