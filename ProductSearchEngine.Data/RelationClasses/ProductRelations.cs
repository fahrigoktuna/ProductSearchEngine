...
namespace ProductSearchEngine.RelationClasses
{
	...
	public partial class ProductRelations
	{
		...
		public virtual List<IEntityRelation> GetAllRelations()
		{
			...
			toReturn.Add(this.LastViewedProductEntityUsingProductId);
		...
		/// <summary>Returns a new IEntityRelation object, between ProductEntity and LastViewedProductEntity over the 1:n relation they have, using the relation between the fields:
		/// Product.Id - LastViewedProduct.ProductId
		/// </summary>
		public virtual IEntityRelation LastViewedProductEntityUsingProductId
		{
			get
			{
				IEntityRelation relation = new EntityRelation(SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany, "LastViewedProducts" , true);
				relation.AddEntityFieldPair(ProductFields.Id, LastViewedProductFields.ProductId);
				relation.InheritanceInfoPkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("ProductEntity", true);
				relation.InheritanceInfoFkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("LastViewedProductEntity", false);
				return relation;
			}
		}
	...
	internal static class StaticProductRelations
	{
		...
		internal static readonly IEntityRelation LastViewedProductEntityUsingProductIdStatic = new ProductRelations().LastViewedProductEntityUsingProductId;
