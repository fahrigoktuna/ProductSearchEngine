...
namespace ProductSearchEngine.RelationClasses
{
	...
	public partial class RoleRelations
	{
		...
		public virtual List<IEntityRelation> GetAllRelations()
		{
			...
			toReturn.Add(this.MembershipEntityUsingRoleId);
			return toReturn;
		}

		#region Class Property Declarations

		/// <summary>Returns a new IEntityRelation object, between RoleEntity and MembershipEntity over the 1:n relation they have, using the relation between the fields:
		/// Role.Id - Membership.RoleId
		/// </summary>
		public virtual IEntityRelation MembershipEntityUsingRoleId
		{
			get
			{
				IEntityRelation relation = new EntityRelation(SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany, "Memberships" , true);
				relation.AddEntityFieldPair(RoleFields.Id, MembershipFields.RoleId);
	...
	{
		internal static readonly IEntityRelation MembershipEntityUsingRoleIdStatic = new RoleRelations().MembershipEntityUsingRoleId;
