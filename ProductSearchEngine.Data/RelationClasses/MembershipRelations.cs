...
namespace ProductSearchEngine.RelationClasses
{
	...
	public partial class MembershipRelations
	{
		...
		/// <summary>Returns a new IEntityRelation object, between MembershipEntity and RoleEntity over the m:1 relation they have, using the relation between the fields:
	...
	internal static class StaticMembershipRelations
	{
		...
		internal static readonly IEntityRelation RoleEntityUsingRoleIdStatic = new MembershipRelations().RoleEntityUsingRoleId;
