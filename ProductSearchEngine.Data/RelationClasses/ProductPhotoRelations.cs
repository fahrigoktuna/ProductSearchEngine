...
namespace ProductSearchEngine.RelationClasses
{
	...
	public partial class ProductPhotoRelations
	{
		...
		/// <summary>Returns a new IEntityRelation object, between ProductPhotoEntity and ProductEntity over the m:1 relation they have, using the relation between the fields:
		...
		public virtual IEntityRelation ProductEntityUsingProductId
		{
			get
			{
				...
				relation.InheritanceInfoFkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("ProductPhotoEntity", true);
				return relation;
			}
		}
	...
	{
		internal static readonly IEntityRelation ProductEntityUsingProductIdStatic = new ProductPhotoRelations().ProductEntityUsingProductId;
